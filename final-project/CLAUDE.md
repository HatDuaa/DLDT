# Quy tắc làm việc — final-project
...
- 25C11050 Nguyễn Đình Lộc — dữ liệu, tiền xử lý, đồ thị (người đang làm việc với Claude).
- 25C15003 Ngô Trương Minh Đạt — baseline, đánh giá, giải thích, phân tích.
- 25C15015 Trần Đắc Khoa — tái lập phương pháp mới (cấp độ 2).

Khi tạo code hoặc tài liệu, ghi rõ phần nào thuộc ai để làm bảng phân công.
...
## Liên hệ với folder seminar

`../bao-cao-seminar-MMKGC/` chứa hai bài báo MMKGC (HFR-MKGC, MDBGF) và dataset MKG-W / MKG-Y / DB15K. Được dùng lại dữ liệu và kiến thức nền, nhưng project này là bài toán **retrieval**, không phải KGC. Không copy kết quả từ seminar sang.
